...
namespace RVModules.RVUtilities.Reflection
{
    ...
    public static class ReflectionHelper
    {
        ...
        public static void CopyFields(object source, object target, bool logAssignments = false)
        {
            ...
            foreach (var targetField in targetFields)
            {
                ...
                {
                    if (sourceField.Name != targetField.Name) continue;
        ...
        /// editor only !!!
        /// </summary>
        public static void CopyFieldsOfUnityObject(Object source, Object target, bool logAssignments = false)
        {
            UnityEditor.Undo.RecordObject(target, $"Copy fields from {source} to {target}");
            CopyFields(source, target, logAssignments);
            UnityEditor.PrefabUtility.RecordPrefabInstancePropertyModifications(target);
        }
        /// <summary>
        /// editor only !!!
        /// </summary>
        public static void CopyGameObjectAllComponentsFields(GameObject source, GameObject target, bool logAssignments = false)
        {
            ...
            foreach (var targetComponent in targetComponents)
            {
                ...
                CopyFieldsOfUnityObject(equivalentSourceComp, targetComponent, logAssignments);
            }
        }
#endif
